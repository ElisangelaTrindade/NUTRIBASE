...
class DietPlanTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        ClinicEvaluation.objects.create(patient=patient1, registered_by=user, nails="forte", skin= "normal", bladder_habits="normal", bowel_habits="normal", additional_information="teste", date_of_consultation="2021-11-12", updated="2021-11-12")
