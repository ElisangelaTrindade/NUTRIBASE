...
class AntopometricEvaluation (models.Model):
  ...
  height = models.DecimalField(max_digits=4, decimal_places=3, db_column='height', verbose_name = _('height'), validators=[validate_greater_than_zero])
  ...
  abdomen_circumference = models.DecimalField(max_digits=6, decimal_places=3, db_column='abdomen_circumference', verbose_name = _('abdomen_circumference'), validators=[validate_greater_than_zero]) 
