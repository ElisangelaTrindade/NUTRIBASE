...
class Command(BaseCommand):
    ...
    groups = {
    'Nutritionist': ['add_antopometricevaluation', 'view_antopometricevaluation', 'delete_antopometricevaluation', 'change_antopometricevaluation','view_clinicevaluation','add_antopometricevaluation','change_antopometricevaluation','delete_antopometricevaluation','view_antopometricevaluation','add_clinicevaluation','change_clinicevaluation','delete_clinicevaluation','view_clinicevaluation', 'add_gastrointestinaltractsymptoms','change_gastrointestinaltractsymptoms',\
